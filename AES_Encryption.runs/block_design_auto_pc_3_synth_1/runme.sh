...
HD_PWD='C:/Users/2adri/AES_Encryption/AES_Encryption.runs/block_design_auto_pc_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_design_auto_pc_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_design_auto_pc_3.tcl

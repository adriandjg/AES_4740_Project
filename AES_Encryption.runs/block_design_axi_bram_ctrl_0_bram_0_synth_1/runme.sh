...
HD_PWD='C:/Users/2adri/AES_Encryption/AES_Encryption.runs/block_design_axi_bram_ctrl_0_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_design_axi_bram_ctrl_0_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block_design_axi_bram_ctrl_0_bram_0.tcl
